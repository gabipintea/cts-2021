...
public class TestStudent {
	...
	public void testSetAgeErrorCondition() {
		...
		try {
			student.setAge(newAge);
			fail("We didn't get an exception for a negative age.");
		} catch (WrongAgeException e) {
			assertTrue(true);
		}
	}
	...
	public void testGetGradesAverageAscendingOrder() throws WrongGradesException {
		...
		assertEquals("Testing with ascending sorted set of grades", 
	...
	public void testGetGradesAverageCardinalityZero() throws WrongGradesException {
		...
		assertEquals("Testing with empty set of grades", expectedAverage, computedAverage, 0);
	}
